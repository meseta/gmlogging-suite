...
throw new Exception("something bad happened") // <--- This of exception object will trigger the global exception handler
...
try {
	...
	if (is_instanceof(_err, Exception)) { // checks if we threw an Exception
